...
(custom-set-variables
 ...
 '(nxml-child-indent 2)
 '(org-agenda-files (quote ("~/.emacs.d/memo/my-emacs-customize.org.txt" "~/.emacs.d/memo/my-emacs-customize-org-mode.org.txt" "f:/goat-pc-data/mydropbox/Dropbox/trunksync/notes/アドベントカレンダーをepubに変換してiPadで読む-m2014-10.org.txt" "~/.emacs.d/memo/sample.org.txt")))
