...
;; =============================================================================
;; * [2012-05-22 火] http://www.emacswiki.org/emacs/FlymakePhp

(defvar phpwin-php.exe-location "c:\\PROGRA~1\\PHP\\php.exe"
  "Location for the PHP.exe executable on windows.")

(when nil
  (setq phpwin-php.exe-location "c:\\PROGRA~1\\PHP\\php.exe")
  )
