...
;; my-os-windows-ime.el
;; ======================================================================
;; * set-keyboard-coding-system
;; ~/.emacs.d/inits/my-coding-system.el では (set-keyboard-coding-system 'cp932)
;; になっているのでこれに倣う。
;; 
;; 日本語入力のための設定
...
;; 実験中。
(when nil
  (add-hook 'w32-ime-on-hook (lambda() (set-cursor-color "green")))
  (add-hook 'w32-ime-off-hook (lambda() (set-cursor-color "red")))
)
...
;; ----------------------------------------------------------------------
;; * [2014-09-08 月] ~/.emacs.d/gnupack-init.el から移動。
;; ----------------------------------------------------------------------
;; * [2014-09-08 月] TODO 
